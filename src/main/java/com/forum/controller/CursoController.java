...
import com.forum.config.errores.TratadorDeErrores;
import com.forum.model.Curso;
import com.forum.record.curso.DatosRespuestaCurso;
import com.forum.record.curso.DatosListadoCurso;
import com.forum.record.curso.DatosActualizarCurso;
import com.forum.record.curso.DatosRegistroCurso;
...
public class CursoController {
    ...
    @PostMapping
    public ResponseEntity<DatosRespuestaCurso> registrarUsuario(
    ...
    @GetMapping
    public ResponseEntity<Page<DatosListadoCurso>> listadoCurso(
            @PageableDefault(size = 10, sort = "cursoId") Pageable paginacion) {
