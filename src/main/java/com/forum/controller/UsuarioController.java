...
import com.forum.record.usuario.DatosRespuestaUsuario;
import com.forum.record.usuario.DatosActualizarUsuario;
import com.forum.record.usuario.DatosListadoUsuario;
import com.forum.record.usuario.DatosRegistroUsuario;
...
public class UsuarioController {
    ...
    @GetMapping
    public ResponseEntity<Page<DatosListadoUsuario>> listadoUsuario(
            @PageableDefault(size = 10, sort = "usuarioId") Pageable paginacion) {
